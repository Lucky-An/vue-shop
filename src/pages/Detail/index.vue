          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                <dd
                  ...
                  @click="setSaleAttrValueListMethods(attr.id,value.id)"
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="plus" @click="skuNumChange('+')">+</a>
                <a href="javascript:" class="mins" @click="skuNumChange('-')">-</a>
              </div>
              <div class="add">
                <button href="javascript:" @click="addToCart" :disabled="isDisabled">加入购物车</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    setSaleAttrValueListMethods(params1, params2) {
      const params = { params1: params1, params2: params2 };
      // console.log(params);
      this.$store.dispatch("setSaleAttrValueList", params);
    },
    setCurrentImgIndex(index) {
      this.currentImgIndex = index;
      // console.log(this.currentImgIndex);
    },
    // 加入购物车按钮跳转到  加入购物车成功界面
    addToCart() {
      const query = { skuId: this.skuInfo.id, skuNum: this.skuNum };
      this.$store
        .dispatch("addToCartVuex", query)
        .then(() => {
